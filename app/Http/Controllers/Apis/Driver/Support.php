...
use App\Models\Support\DriverTicket as Ticket;
use Validator;
...
class Support extends Controller
{
    ...
    /**
     * get all driver raised tickets
     */
    public function getTickets(Request $request)
    {
        $tickets = Ticket::where('driver_id', $request->auth_driver->id)->orderBy('updated_at', 'desc')->get();
    ...
    public function createTicket(Request $request)
    {
        ...
        /** create new ticket */
        $ticket = new Ticket;
        $ticket->driver_id = $request->auth_driver->id;
        ...
        $body = "Driver {$request->auth_driver->email} has raised new support ticket. Check out from admin panel.";
