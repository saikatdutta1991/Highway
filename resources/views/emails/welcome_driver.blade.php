            ...
            <table role="presentation" cellspacing="0" cellpadding="0" border="0" align="center" width="600" style="margin: auto;" class="email-container">
                ...
                <tr>
                    <td bgcolor="#ffffff" style="padding: 40px 40px 20px;">
                        <h1 style="margin: 0; font-family: sans-serif; font-size: 24px; line-height: 125%; color: #333333; font-weight: normal;">Welcome, {{$driver->fname}}  :)</h1>
                    </td>
                </tr>
                <tr>
                    <td bgcolor="#ffffff" style="padding: 0 40px 40px; font-family: sans-serif; font-size: 15px; line-height: 140%; color: #555555;">
                        <p style="margin: 0;">We're really excited you've joined with us as partner. Wait for a while your account to be approved by admin before start getting rider trip requests. <br><br>If you have regisgterd through Social Login(Facebook or Google) upload your documents.<br><br>In case you have any questions, feel free to reach out to us at {{$website_contact_email}}</p>
                    </td>
                </tr>
                <tr>
                    <td bgcolor="#ffffff" style="padding: 0 40px 40px; font-family: sans-serif; font-size: 15px; line-height: 140%; color: #555555;">
