...
@section('terms_active', 'active')
@section('title', 'Terms Content Management')
@section('top-header')
            ...
            <div class="card">
                <div class="header">
                    <h2>
                        ...
                        <small>Add your TERMS & CONDITIONS content here</small>
                    </h2>
                </div>
                <div class="body">
                    <form id="terms_form">
...
<script>
    ...
    var  termssaveapi = "{{route('admin.save.content.terms')}}"
